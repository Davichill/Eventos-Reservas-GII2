...
/* @var $searchModel backend\modules\menu_coffee_break\models\search\CoffeeBreakSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Menu Coffee Breaks';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="menu-coffee-break-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Menu Coffee Breaks listing',
