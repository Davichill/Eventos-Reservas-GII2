...
class CoffeeBreakController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new menuCoffeeBreak",
                ...
                return [
                    ...
                    'title'=> "Create new menuCoffeeBreak",
                    'content'=>'<span class="text-success">Create menuCoffeeBreak success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update menuCoffeeBreak #".$id,
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing menuCoffeeBreak model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
     ...
     * @param integer $id
     * @return menuCoffeeBreak the loaded model
