...
/* @var $searchModel backend\modules\menu_desayuno\models\search\MenuDesayunoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Menu Desayunos';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="menu-desayunos-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Menu Desayunos listing',
