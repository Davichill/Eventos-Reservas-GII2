...
{   
    ...
    // Obtenemos los pagos relacionados para mostrarlos en el expediente
    ...
    if($request->isAjax){
        ...
        return [
            ...
            'content'=>$this->renderAjax('view', [
                'model' => $model,
                'pagos' => $pagos, // Pasamos los pagos al renderAjax
            ]),
        ...
        return $this->render('view', [
            'model' => $model,
            'pagos' => $pagos, // Pasamos los pagos al render normal
        ]);
    }
}
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Reservas",
                    'content'=>'<span class="text-success">Create Reservas success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
