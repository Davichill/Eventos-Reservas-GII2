...
return [
    ...
    [
        ...
        'hAlign' => 'center',
        'value' => function ($model) {
            // CAMBIO AQUÍ: Apuntamos a 'publico/ver' y usamos el campo 'token'
            $url = Yii::$app->urlManager->createAbsoluteUrl(['publico/ver', 'token' => $model->token]);
    ...
    [
        ...
        'dropdown' => false,
        'vAlign' => 'middle',
        'width' => '160px', // Aumentado ligeramente para acomodar el nuevo botón
        'template' => '{view} {update} {delete} {pdf}', // AÑADIDO {pdf}
        'urlCreator' => function ($action, $model, $key, $index) {
            return Url::to([$action, 'id' => $key]);
        },
        'buttons' => [
            'pdf' => function ($url, $model) {
                return Html::a('<i class="fas fa-file-pdf"></i>', ['generar-cotizacion', 'id' => $model->id], [
