...
/* @var $searchModel backend\modules\menu_coctel\models\search\MenuCoctelSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Menu Coctels';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="menu-coctel-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Menu Coctels listing',
