...
/* @var $searchModel backend\modules\menu_almuerzo_cena\models\search\ReservasSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Menu Almuerzo Cenas';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="menu-almuerzo-cena-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Menu Almuerzo Cenas listing',
